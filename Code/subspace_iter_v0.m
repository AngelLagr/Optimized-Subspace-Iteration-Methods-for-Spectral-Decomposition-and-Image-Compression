...
function [ V, D, it, flag ] = subspace_iter_v0( A, m, eps, maxit )
    ...
    while (~conv && k < maxit) % ~ est un non logique
    ...
    % dOn réalise la décomposition spectrale de H, le quotient de Rayleigh
    [W,D] = eig(H);
    ...
    % On calcule les m vecteurs propres dominants de A à partir de ceux de H
    V = V*X;
